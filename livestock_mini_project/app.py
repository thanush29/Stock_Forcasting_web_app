...
st.title(app_name)
st.subheader('This app is created to forecast the stock market price of the selected company.That company you want to analysis')
...
start_date = st.sidebar.date_input('Start date', date(2014, 1, 1))
...
# redirect urls
github_redirect_url = "https://github.com/thanush29"
twitter_redirect_url = "https://twitter.com/Thanush_29"
...
st.markdown(f'<div class="footer">Made with Team 11 TSS <a href="{github_redirect_url}"><img src="{github_url}" width="30" height="30"></a>'
             f'<a href="{twitter_redirect_url}"><img src="{twitter_url}" width="30" height="30"></a>'' | Credits: TSS</div>', unsafe_allow_html=True)